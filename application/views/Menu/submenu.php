            ...
            <?php foreach ($submenu as $sm) : ?>
                <tr>
                    ...
                    <td>
                        ...
                        <button onclick="hapusSubmenu('<?=base_url('menu/hapusSubmenu/') . $sm['id'] ?>')"  class="btn btn-danger btn-sm tombol hapus">Delete</button>
                    </td>
                </tr>
                <?php $i++; ?>
            <?php endforeach; ?>
            ...
            <div class="modal-content">
                ...
                <form action="<?= base_url('menu/submenuedit'); ?>" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <select name="menu_id" id="menu_id" class="form-control">
                                <option value="<?= $sm['menu_id'] ?>" class="value">Select Menu</option>
                                <?php foreach ($menu as $m) : ?>
                                    <option value="<?= $m['id']; ?>"><?= $m['menu']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" id="icon" value="<?= $sm['icon'] ?>" name="icon" placeholder="Submenu Icon">
                        </div>
                        <div class="form-group">
                            <div class="form-check">
